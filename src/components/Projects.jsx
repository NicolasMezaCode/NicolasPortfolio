            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center flex-col justify-center bg-red-400 opacity-0 hover:opacity-100 transition duration-300 ease-in-out">
                <div className="text-black text-center m-3 sm:m-5">
                  <h3 className="text-xs sm:text-2xl font-semibold sm:mb-2">Created a website to enhance the online presence of a textile company.Using HTML, Tailwind CSS, and JavaScript to deliver a functional platform for customer engagement.</h3>                  
                </div>
