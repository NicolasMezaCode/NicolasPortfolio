    ...
    <div className="bg-[url('./assets/2.png')] md:bg-[url('./assets/output-onlinepngtools.png')] flex justify-center flex-col  items-center">
        ...
        <section className='w-fit flex flex-col justify-center items-center'>
          ...
          <div className='flex justify-center  items-center max-w-[450px] max-h-[584px] '>
            <h4 className='p-5 text-lg font-medium sketchy bg-yellow-300 text-center mb-10'>Is a Fullstack team project using React that shows where you can find and look all your favorite games using the IGDB database and firebase for the authentication and storing the user data.</h4>
          </div>
        </section>      
    </div>
  )
