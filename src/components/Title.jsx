...
export default function Title() {
  return (
    <section className="bg-[url('./assets/composition-book-cover-black-and-white-background-abstract-wallpaper-texture-or-pattern-grain-or-noise-marble-pattern-fabric-and-surface-wrapping-paper-flat-de.jpg')] flex justify-center items-center  pt-10 pb-10">
